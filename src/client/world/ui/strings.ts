...
const en = {
  ...
  "air.assignHint":
    "A wing flies from its base to a zone, not to a province, and stays there until you move it. Two orders: fight for the sky, or support the ground under it. A fleet is the same idea on water — patrol a sea and it covers your shipping and contests anyone else there, or send it hunting theirs.",
  ...
  "mission.patrol": "Patrol this water",
  "mission.raiding": "Hunt their shipping",
...
const de: Record<StringKey, string> = {
  ...
  "air.assignHint":
    "Eine Staffel fliegt von ihrer Basis in eine Zone, nicht in eine Provinz, und bleibt dort, bis du sie verlegst. Zwei Aufträge: um den Himmel kämpfen, oder den Boden darunter unterstützen. Eine Flotte ist dasselbe auf Wasser — patrouilliert sie ein Seegebiet, deckt sie deine Schifffahrt und bestreitet es jedem anderen; oder du schickst sie auf deren Schifffahrt.",
  ...
  "mission.ground_support": "Boden unterstützen",
  "mission.patrol": "Dieses Wasser patrouillieren",
  "mission.raiding": "Ihre Schifffahrt jagen",
